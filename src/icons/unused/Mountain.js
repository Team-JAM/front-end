...
const SVG = ({
	...
	>
		<polyline
			style={{ fill: '#4C5E66' }}
			points='13.629,443.412 206.175,0.329 423.186,487.787 182.873,511.671 '
		/>
		<polygon
			style={{ fill: '#829399' }}
			points='218.103,154.775 245.236,154.775 243.149,269.566 274.455,250.782 313.651,376.458 
	356.677,338.389 206.175,0.329 '
		/>
		<polyline
			style={{ fill: '#4C5E66' }}
			points='256.626,401.773 364.222,165.206 508.443,443.572 '
		/>
		<polygon
			style={{ fill: '#829399' }}
			points='364.222,165.211 365.245,300.873 392.377,300.873 417.85,472.82 508.441,443.569 '
		/>
		<path
			style={{ fill: '#8BC923' }}
			d='M0,511.671h512v-50.226c0-25.275-20.266-46.115-45.551-46.313c-0.157,0-0.313-0.01-0.47-0.01
	...
	c-0.699,0-1.398,0.01-2.087,0.031c-32.068,1.054-57.343,27.79-57.792,59.869L0,511.671z'
		...
		<g>
			<path
				style={{ fill: '#7EB515' }}
				d='M198.464,490.017c-6.877,6.762-10.509,14.151-11.886,21.654H512v-23.616
		...
		C283.899,480.803,234.383,454.098,198.464,490.017z'
			...
			<path
				style={{ fill: '#7EB515' }}
				d='M0.376,511.671h182.497c-9.069-13.107-24.284-21.654-41.377-21.654
		...
		<g>
			<polygon
				style={{ fill: '#BFC5D2' }}
				points='133.93,166.578 144.992,240.597 191.952,181.114 244.077,218.662 285.684,178.933 
		206.175,0.329 	'
			/>
			<polygon
				style={{ fill: '#BFC5D2' }}
				points='281.781,346.455 346.909,320.419 399.004,345.631 418.915,321.984 453.509,337.554 
		...
		<g>
			<polygon
				style={{ fill: '#F1F5FE' }}
				points='218.103,154.775 245.236,154.775 244.077,218.662 285.684,178.933 206.175,0.329 	'
			/>
			<polygon
				style={{ fill: '#F1F5FE' }}
				points='364.222,165.211 365.245,300.873 392.377,300.873 399.004,345.631 418.915,321.984 
		453.509,337.554 	'
			/>
		</g>
	</svg>
