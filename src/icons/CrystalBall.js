...
const SVG = ({
	...
	<svg
		...
		<g
			id='Crystal_Ball-magic-wizard-shop-fortunes'
			data-name='Crystal Ball-magic-wizard-shop-fortunes'>
			...
			<path
				d='m52 15h-48v6a4 4 0 0 0 8 0 4 4 0 0 0 8 0 4 4 0 0 0 8 0 4 4 0 0 0 8 0 4 4 0 0 0 8 0 4 4 0 0 0 8 0 4 4 0 0 0 8 0v-6z'
				fill='#2d2d30'
			/>
			...
			<path d='m60 14v6a4 4 0 0 1 -8 0v-6z' fill='#ff9478' />
			<path d='m44 14v6a4 4 0 0 1 -8 0v-6z' fill='#ff9478' />
			<path d='m28 14v6a4 4 0 0 1 -8 0v-6z' fill='#ff9478' />
			<path d='m12 14v6a4 4 0 0 1 -8 0v-6z' fill='#ff9478' />
			...
			<ellipse cx='40' cy='48.5' fill='#a78966' rx='7' ry='2.5' />
			<circle cx='40' cy='40' fill='#44ffe8' r='8' />
			<path d='m36 40a4 4 0 0 1 4-4v-2a6.006 6.006 0 0 0 -6 6z' fill='#fff' />
			<path d='m28 30h2v2h-2z' fill='#ffda44' />
			<path d='m28 34h2v2h-2z' fill='#ffda44' />
			<path d='m26 32h2v2h-2z' fill='#ffda44' />
			<path d='m30 32h2v2h-2z' fill='#ffda44' />
			<g fill='#bdfdff'>
			...
			<path d='m50 48h2v2h-2z' fill='#ffda44' />
			<path d='m50 52h2v2h-2z' fill='#ffda44' />
			<path d='m48 50h2v2h-2z' fill='#ffda44' />
			<path d='m52 50h2v2h-2z' fill='#ffda44' />
		</g>
	</svg>
);
